...
class ResponseMin(ResponseFieldAggregationBase):
    ...
    :type field: str
    :param value: The minimum value of the field for the match set.
    :type value: float
    """
    ...
    def __init__(self, *, errors=None, debug=None, name: str=None, estimated_count: int=None, aggregations=None, field: str=None, value: float=None, **kwargs) -> None:
        super(ResponseMin, self).__init__(errors=errors, debug=debug, name=name, estimated_count=estimated_count, aggregations=aggregations, field=field, **kwargs)
        self.value = value
        self._type = 'Min'
