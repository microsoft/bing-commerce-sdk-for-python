...
class ResponseCategoryFacet(ResponseFacetBase):
    ...
    def __init__(self, *, errors=None, debug=None, name: str=None, estimated_count: int=None, aggregations=None, field: str=None, label: str=None, refinements=None, **kwargs) -> None:
        super(ResponseCategoryFacet, self).__init__(errors=errors, debug=debug, name=name, estimated_count=estimated_count, aggregations=aggregations, field=field, label=label, **kwargs)
        self.refinements = refinements
        self._type = 'CategoryFacet'
