...
class ResponseNumberRefinement(ResponseRefinementBase):
    ...
    def __init__(self, *, estimated_count: int=None, value: float=None, **kwargs) -> None:
        super(ResponseNumberRefinement, self).__init__(estimated_count=estimated_count, **kwargs)
        self.value = value
