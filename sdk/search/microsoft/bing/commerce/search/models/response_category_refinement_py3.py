...
class ResponseCategoryRefinement(ResponseStringRefinement):
    ...
    def __init__(self, *, errors=None, debug=None, name: str=None, estimated_count: int=None, aggregations=None, label: str=None, value: str=None, refinements=None, **kwargs) -> None:
        super(ResponseCategoryRefinement, self).__init__(errors=errors, debug=debug, name=name, estimated_count=estimated_count, aggregations=aggregations, label=label, value=value, **kwargs)
