...
class ResponseBoolFacet(ResponseFacetBase):
    ...
    :param refinements:
    :type refinements:
     list[~microsoft.bing.commerce.search.models.ResponseBoolRefinement]
    """
    ...
    _attribute_map = {
        ...
        'refinements': {'key': 'refinements', 'type': '[ResponseBoolRefinement]'},
    }
    ...
    def __init__(self, *, errors=None, debug=None, name: str=None, estimated_count: int=None, aggregations=None, field: str=None, label: str=None, refinements=None, **kwargs) -> None:
        super(ResponseBoolFacet, self).__init__(errors=errors, debug=debug, name=name, estimated_count=estimated_count, aggregations=aggregations, field=field, label=label, **kwargs)
        self.refinements = refinements
        self._type = 'BoolFacet'
